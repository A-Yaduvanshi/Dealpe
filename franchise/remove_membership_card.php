 <?php
     ...
     $sql = "SELECT * FROM `franchisesignup` WHERE `membership_card` != ''; ";
    ...
    <div class="container">
       ...
       <div class="container" style="margin-top:20px;">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 border" style="padding: 20px;text-align:center;">
                        
                        <h5>Remove Franchise membership card</h5>
                       <input style="width: 300px;padding:10px; border-radius: 25px;" list="list1" placeholder="Remove Franchise Card">
                       <datalist id="list1">
            ...
            <div class="form first" style="text-align: center;margin:20px;border:2px solid red;width:80%;padding:10px;justify-items: center;">
                <div class="details personal">
                    ...
                    <div class="fields" >
                        <div class="input-fields">
                            ...
                            <input  style="width:300px; padding:10px;border-radius:22px;" type="text" placeholder="Enter Card Number" name="franchise_name" required>
                        </div>
                    </div>
