        ...
        <div class="container pd-x-0">
            <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                <div>
                    ...
                    <h4 style="color:#951010;font-weight: bold;" class="mg-b-0 tx-spacing--1">Franchise Data..</h4>
                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form>
                                        <div class="mb-3">
                                            <label for="lead_id" class="col-form-label">Business Name</label>
                                            <input type="text" class="form-control" id="lead_id">
                                        </div>
                                        <div class="mb-3">
                                            <label for="lead_id" class="col-form-label">owner Name</label>
                                            <input type="text" class="form-control" id="lead_id">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="last_name" class="col-form-label">Generate Code</label>
                                            <input type="text" class="form-control" id="last_nam"e>
    ...
    <div id="leavedetails" class="modal fade effect-scale" role="dialog">
        <div class="modal-dialog modal-dialog2 modal-lg">
            <div class="modal-content">
                ...
                <form role="form" id="leavedetails_form" action="franchiseprofile.php" method='post'>
                    <div class="modal-body">
