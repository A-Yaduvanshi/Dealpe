         ...
         <div class="container" style="margin-top:50px;">
             ...
             <div class="row">
                 ...
                 <div class="col-sm-6 border" style="padding: 10px; font-weight:bold;text-align:center;">
                     ...
                     <h5>Available MembershipCard</h5>
                     <input list="list2">
                     <datalist id="list2">
                         <?php while ($row_query = mysqli_fetch_assoc($membership_card)) { ?>

                             <option> <?php echo $row_query['membership_card'] ?></option>
                         <?php } ?>
                     </datalist>
                 ...
                 <div class="details personal">
                     ...
                     <div class="fields">
                         <div class="input-field">
                             <label>Assign Card Name</label>
                             <input type="text" placeholder="Enter your name" name="franchise_name" required>
                         </div>

                         <div class="input-field">
                             <label>Franchise Name</label>
                             <input type="text" placeholder="Enter your name" name="membership_card" required>
                         </div>

                         <div class="input-field">
                             <label>Expiry Date</label>
                             <input type="date" placeholder="Enter your email" name="exiry_date" required>
                         </div>
                     </div>

                     <button style="margin-left: 180px; background-color: transparent;">
