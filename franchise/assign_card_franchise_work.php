...
$six_months = "SELECT * FROM `membership_card` WHERE `assign` = 1 and `asign_count` =1 And `F_id`=$franchise";
$runsix = mysqli_query($conn, $six_months);
$rowsix = mysqli_num_rows($runsix);
// $unsoldCard = $rowTHree + $rowsix
$sql_2 = "SELECT * FROM `membership_card` WHERE `assign` = 1 and `asign_count` =1 And `F_id`=$franchise";
            ...
            <div class="row mx-2 p-4 border">
                ...
                <div class="col-3  ">
                    ...
                    <datalist id="list">
                        ...
                        <?php
                        include "../api/connection.php";
                        $sql = "SELECT * FROM `sales` where `frachise_id`=$franchise";
