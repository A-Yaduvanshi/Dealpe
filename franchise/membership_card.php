...
<html >
  ...
  <body class="d-flex flex-column h-100p" onload="FreshworksWidget('hide', 'launcher');">
    ...
    <!-- navbar --><div class="content content-fixed">
        ...
        <a href="./franchisedashboard.php"> <button style="background-color: #6c63ff;color:white;float: right;padding:8px; border-radius: 10px; margin-left:10px; margin-top:5px">Go Home</button></a>
            <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                <div>
                    ...
                    <h4 style="font-weight: bold;" class="mg-b-0 tx-spacing--1">Stock Report</h4>
                </div>
        ...
        <!-- Main content -->
        <div class="container pd-x-0">
            <div data-label="Stock Details" class="df-example demo-table mg-t-28">
                <table class="table tx-12" id="example1">
                    <thead>
                        <tr>
                        <th>NO.</th>
            ...
            <tbody id="table_filter">
                    ...
                    <tr>
                        ...
                        <td> <a href="./removesale.php?id=<?php echo $res['id']; ?>"><Button class="btn btn-block bg-danger text-white">
                                    Remove</Button></a></td>
                    </tr>
                <?php }  ?>
