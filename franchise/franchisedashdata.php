...
<html >
  ...
  <body class="d-flex flex-column h-100p" onload="FreshworksWidget('hide', 'launcher');">
    ...
    <!-- navbar --><div class="content content-fixed">
        ...
        <a href="../franchise/franchisedashboard.php"> <button style="background-color: #6c63ff;color:white;float: right;padding:8px; border-radius: 10px; margin-left:10px; margin-top:5px">Go Home</button></a>
