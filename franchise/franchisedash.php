...
<html >
  <head>
    ...
    <!-- <link href="https://newui.campus365.io/uploads/school_content/admin_small_logo/1.png" rel="shortcut icon" type="image/x-icon"> -->
    <link rel="stylesheet" href="https://newui.campus365.io/backend/datepicker/css/bootstrap-datetimepicker.css">
    <!-- vendor css -->
    <link href="https://newui.campus365.io/backend/lib/@fortawesome/fontawesome-free/css/all.min.css" rel="stylesheet">
    <link href="https://newui.campus365.io/backend/lib/ionicons/css/ionicons.min.css" rel="stylesheet">
    <link href="https://newui.campus365.io/backend/lib/jqvmap/jqvmap.min.css" rel="stylesheet">
    <link href="https://newui.campus365.io/backend/lib/datatables.net-dt/css/jquery.dataTables.min.css" rel="stylesheet">
    <link href="https://newui.campus365.io/backend/lib/datatables.net-responsive-dt/css/responsive.dataTables.min.css" rel="stylesheet">
    <link href="https://newui.campus365.io/backend/lib/prismjs/themes/prism-vs.css" rel="stylesheet">
    <link href="https://newui.campus365.io/backend/lib/typicons.font/typicons.css" rel="stylesheet">
    <link href="https://newui.campus365.io/backend/lib/select2/css/select2.min.css" rel="stylesheet">
    <link href="https://newui.campus365.io/backend/lib/fullcalendar/fullcalendar.min.css" rel="stylesheet">
    <link href="https://newui.campus365.io/backend/assets-new/css/buttons.dataTables.min.css" rel="stylesheet"></script>
    <link href="https://newui.campus365.io/backend/assets-new/css/fixedColumns.dataTables.min.css" rel="stylesheet"></script>
    <link href="https://newui.campus365.io/backend/lib/quill/quill.core.css" rel="stylesheet">
    <link href="https://newui.campus365.io/backend/lib/quill/quill.snow.css" rel="stylesheet">
                ...
                <table class="table tx-13" id="example1">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Owner_image</th>
                            <th class="text-center">Business_Name</th>
                            <th class="text-center">owner_name</th>
                            <th class="text-center">Business_email</th>
                            <th class="text-center">Password</th>
                            <th class="text-center">selectt</th>
                            ...
                            <th class="text-center">Pan_number</th>
                         </tr>
                    </thead>
...
<?php while ($res = mysqli_fetch_row($query)) { ?>
    ...
    <tr>
        ...
        <td  class="text-center"> <img src="<?php echo $res['13']; ?>"
