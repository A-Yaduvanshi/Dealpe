...
`Customer_email`, `Password`, `gender`,  `Address`, `Landmark`,`create_date`, 
 `state`, `Distict`, `mobile_no`, `pin_code`, `Owner_image`,`commission`)
  VALUES (NULL, '$sale_id', '$customer_name', '$date_of_birth',
   '$customer_email', '$password', '$gender',  '$address', '$landmark',current_timestamp(),
    '$state', '$disrict', '$mobile', '$pin_code','$main_image_address','$commission')";
