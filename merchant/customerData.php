...
<script>
    function myFunction() {
        window.location.href = '../merchant/merchent-dash.php'

    }
</script>

<body>
    <button onclick="myFunction()" style="width: 100px; height:40px; border-radius:10px; margin-left:50px; background-color:transparent; color:gray; font-size: 15px;margin: 20px;">Go Home</button>
