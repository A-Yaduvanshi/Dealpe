...
<body>
    <div class="container">
        <header style="font-weight: bold;">Generate Bill</header>
                ...
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" placeholder="Enter your name" name="membership_name" required>
                        </div>
                  ...
                  <button class="nextBtn" >
                    <a href="./Customerbil.php"><span  class="btn ">Submit</span></a>
