        ...
        <div class="contact-container">
            ...
            <div class="contact-form">
                ...
                <div class="contact-formBox">
                    ...
                    <form class="contact-inputBox w100" action="../api/viewcomplainapi.php">
                        <textarea name="complain"  required></textarea>
                        <span>Complaints/Suggestions here...</span>
                        <input type="submit">
                    </form>
                    <button class="btn text-white" ><a href="http://localhost/deal/api/viewcomplainapi.php?=<?php echo $res['Customer_Email']?> " ></a>Send Complain</button>
                </div>
            </div>
        </div>
