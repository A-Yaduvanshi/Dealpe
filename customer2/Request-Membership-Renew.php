            ...
            <div class="contact-form">
                ...
                <div class="contact-formBox">
                    ...
                    <!-- <div class="contact-inputBox w50" style="display: flex;">
                        ...
                        <input type="hidden" value="<?php echo $row['special_id']; ?>" name="special_id"  required>
...
<div class="contact-inputBox w100">
                    ...
                    <div class="contact-inputBox w100">
                        <textarea id="" name="membership_plan" required></textarea>
                        <span>Request New Membership Plan</span>
                    </div>
                    <button type="submit" class="btn text-white">Request New Membership Plan</button>
                </form>
                </div>
            </div>
        </div>
