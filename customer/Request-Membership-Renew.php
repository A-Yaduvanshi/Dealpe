...
<head>
    ...
    <title>request_new_membership</title>
    <style>
        /* 
  Inspired from 
        ...
        <div class="col-md-9">
            ...
            <div class="row" style="height:100%">
                ...
                <div class="col-md-9">
                    ...
                    <form method="get" action="../api/request_new_membership.php">
                        ...
                        <!--  -->
                                 ...
                                 <div class="contact-inputBox w400">
                        <textarea style="width: 500px; height:200px" id="" name="membership_plan" placeholder="Request New Membership Plan" required></textarea>
                        <!-- <span>Request New Membership Plan</span> -->
                    </div>
                             ...
                             <div class="row mt-5">
                                ...
                                <div class="col">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-block">Request New Membership Plan</button>
