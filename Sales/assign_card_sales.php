...
//3 months
$sql_2 = "SELECT * FROM `membership_card` WHERE `sales_person` = '" . $_SESSION['customer_name'] . "'";
...
// echo $bussiness;
$three_months = "SELECT COUNT(*) as total_pet FROM `membership_card` WHERE `sales_person`='" . $bussiness . "'AND `sales_select` = 1 AND `sale_count` =1";
$runthree = mysqli_query($conn, $three_months);
$rowTHree = mysqli_fetch_assoc($runthree);
$totalThree = $rowTHree['total_pet'];

$six_months = "SELECT COUNT(*) as total_pet FROM `membership_card` WHERE `sales_person`='" . $bussiness . "' AND`sales_select` = 1 AND `sale_count` =1";
...
// 6 month
$sql_6 = "SELECT * FROM `membership_card` WHERE `sales_person` = '" . $_SESSION['customer_name'] . "' ";
            ...
            <div class="form first" style="margin-left: 100px;">
                ...
                <div class="fields">
                    ...
                    <div class="input-field">
                        ...
                        <input name="exiry_date" placeholder="enter month" required>
